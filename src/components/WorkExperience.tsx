...
function WorkPeriod({ start, end }: WorkPeriodProps) {
  return (
    <div
      className="text-sm tabular-nums text-[#000000]"
  ...
  return (
    <Card className="py-1 print:py-0">
      <CardHeader className="print:space-y-1">
        ...
        <h4 className="font-mono text-sm font-semibold leading-none print:text-[12px] text-[#000000]">
          {title}
        </h4>
      </CardHeader>

      <CardContent>
        <div className="mt-2 text-xs text-[#000000] print:mt-1 print:text-[10px] text-pretty">
          {description}
        </div>
        <div className="mt-2">
          <BadgeList
